...
public class Print {
  ...
  public static void updateTime() {
	...
	public static void allCategoriesList(List<MovieResponseAPI> movieResponsePages, Map<Integer, List<Integer>> listAdventure,
			...
			for (int j : listAdventure.keySet()) {
				...
				if (listAdventure.get(j) != null && listAdventure.get(j).size() > 0)
					for (Integer i : listAdventure.get(j)) {
						...
						if (j < movieResponsePages.size() && movieResponsePages.get(j) != null && movieResponsePages.get(j).getMovies() != null
	...
	public static void labelsPerPage(int i, Map<Integer, List<Integer>> listAdventure, Map<Integer, List<Integer>> listAnimal, Map<Integer, List<Integer>> listPrincess, Map<Integer, List<Integer>> listTech) {
		if (ACTIVATED) {
